...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h5_Username_oxd-text oxd-text--h5 orangehrm_5e9baf'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/h6_Buzz_oxd-text oxd-text--h6 oxd-topbar-he_ad8d38'))
